...
const char HTTP_HEADTITLE[] PROGMEM = "<title>ESP/LSI Wind meter</title>";
...
const char HTTP_CONTENTSTART[] PROGMEM = "<div class='b'><h2>ESP/LSI Wind meter</h2><div class='m'><a href='/'>Home</a> | <a href='wifi' class='w'>WiFi</a> | <a href='settings' class='s'>Settings</a></div><div class='p'>";
